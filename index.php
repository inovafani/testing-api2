...
<html lang="en">
  ...
  <body class="mt-5">
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <a class="navbar-brand" href="#">Inov Afani</a>
        <button
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container text-center">
        <img
          ...
          width="25%"
        />
        <h1 class="display-4">Inov Afani Eka Putra</h1>
        <p class="lead">Welcome to my portofolio</p>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col">
            <p>
              ...
              eos possimus sit dicta officiis maiores est ipsam quia, a
              praesentium id dolores magnam. Culpa quaerat enim ipsam! Commodi,
              expedita!
            </p>
          </div>
          <div class="col">
            <p>
              ...
              ducimus quae, assumenda exercitationem tempore quisquam quibusdam
              quos corporis quis ea, sed dolorum? Reiciendis illo dolorem ipsam
              itaque, id nam.
            </p>
          </div>
        </div>
            ...
            <div class="card text-white bg-primary mb-3">
              <div class="card-body text-center">
                ...
                <p class="card-text">
                  ...
                  Tenetur illo blanditiis quia distinctio! Pariatur odit
                  inventore qui, ipsum doloribus non sapiente nihil.
                </p>
              </div>
            </div>
            <ul class="list-group">
              ...
              <li class="list-group-item">Jl Telaga Warna No 98, Malang</li>
